import { Ref } from 'vue'
import { ActivityLogInterface, ContactInterface, UserInterface } from './index'

export type ChartMethodType = 'annual' | 'count'
export type ChartType = | 'bar' | 'pie' | 'doughnut' | 'line' | 'polarArea' | 'radar'
export type ColorItemType = string | null
...
export type ObjectType = | ActivityLogInterface | ContactInterface | UserInterface | undefined
